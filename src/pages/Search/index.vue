            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a href="#">综合<span v-show="isOne && isAsc">↑</span><span v-show="isOne && isDesc">↓</span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a href="#">价格<span v-show="isTwo && isAsc">↑</span><span v-show="isTwo && isDesc">↓</span></a>
                </li>
              </ul>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      //向服务器发请求获取search模块并且根据参数不同返回不同数据
      getData(){
    ...
    watch:{
      $route:{
        handler:function(val,oldvalue){
          Object.assign(this.searchParams,val.query,val.params)
          this.getData()
          this.searchParams.category1Id = undefined
          this.searchParams.category2Id = undefined
          this.searchParams.category3Id = undefined
